...
startVariable = "q7_2"
numberOfCbclVariables = 204

--openEndedIndexes = []

openEndedIndexes = [1, 3, 5, 12, 14, 16, 18, 25, 27, 29, 31, 35, 37, 39, 41,
...
toResponses row =
    let raw = map toResponse row in
        ...
        ++ (map rescaleActivity (take 1 (drop 32 raw)))
...
rescaleActivity (Just 4) = Nothing
rescaleActivity r = r
